...
Use the following information to understand how to create your document:
    - create your file under `docs/shared/handoffs/TICKET-ID/YYYY-MM-DD_HH-MM-SS_TICKET-ID_description.md`, where:
    ...
    - Examples:
        - With ticket: `2025-01-08_13-55-22_TICKET-1234_create-context-compaction.md`
...
### 3. Approve and Sync
Run `git add docs/` to save the document.
...
```bash
/resume_handoff docs/shared/handoffs/TICKET-1234/2025-01-08_13-44-55_TICKET-1234_create-context-compaction.md
```
</example_response>
