...
2a. read .github/prompts/research_codebase.prompt.md for guidance on effective codebase research
...
2g. document findings in a new docs document: `docs/shared/research/YYYY-MM-DD-ENG-XXXX-description.md`
...
3d. run `git add docs/` to save the research
...
Created at docs/shared/research/YYYY-MM-DD-ENG-XXXX-description.md
