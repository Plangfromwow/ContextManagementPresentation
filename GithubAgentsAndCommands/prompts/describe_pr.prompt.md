...
1. **Read the PR description template:**
   ...
   - If it doesn't exist, inform the user that their `docs` setup is incomplete and they need to create a PR description template at `docs/shared/pr_description.md`
