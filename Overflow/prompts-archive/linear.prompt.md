...
You are tasked with managing Linear tickets, including creating tickets from docs documents, updating existing tickets, and following the team's specific workflow patterns.
...
1. Create a new ticket from a docs document
...
```
I'll help you create a Linear ticket from your docs document. Please provide:
...
### URL Mapping for docs documents
When referencing docs documents, always provide GitHub links using the `links` parameter:
- `docs/shared/...` → `https://github.com/humanlayer/docs/blob/main/repos/humanlayer/shared/...`
- `docs/allison/...` → `https://github.com/humanlayer/docs/blob/main/repos/humanlayer/allison/...`
- `docs/global/...` → `https://github.com/humanlayer/docs/blob/main/global/...`
...
5. **Draft the ticket summary:**
   ...
   **Description**:
   ...
   ## References
   - Source: `docs/[path/to/document.md]` ([View on GitHub](converted GitHub URL))
...
8. **Post-creation actions:**
   ...
   - Ask if user wants to:
     ...
     - Update the original docs document with the ticket reference
   - If yes to updating docs:
     ```
...
3. **File reference formatting:**
   - Wrap paths in backticks: `docs/allison/example.md`
...
4. **Comment structure example:**
   ...
   - `docs/shared/rate_limit_analysis.md` ([GitHub](link))
   ```
