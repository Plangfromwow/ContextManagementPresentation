...
0c. use `linear` cli to fetch the selected item into docs with the ticket number - ./docs/shared/tickets/ENG-xxxx.md
...
0.  read .github/prompts/linear.prompt.md
...
1a. read .github/prompts/create_plan.prompt.md
...
1e. if the research is insufficient or has unaswered questions, create a new plan document following the instructions in .github/prompts/create_plan.prompt.md

think deeply

2. when the plan is complete, `git add docs/` and attach the doc to the ticket using the MCP tools and create a terse comment with a link to it (re-read .github/prompts/linear.prompt.md if needed)
...
Created at docs/shared/plans/YYYY-MM-DD-ENG-XXXX-description.md
Synced to docs repository
