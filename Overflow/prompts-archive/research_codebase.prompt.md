...
3. **Spawn parallel sub-agent tasks for comprehensive research:**
   ...
   **For docs directory:**
   - Use the **codebase-locator** agent to discover what documents exist about the topic
   - Use the **codebase-analyzer** agent to extract key insights from specific documents (only the most relevant ones)

   **For web research (only if user explicitly asks):**
   - Use the **web-search-researcher** agent for external documentation and resources
   - IF you use web-research agents, instruct them to return LINKS with their findings, and please INCLUDE those links in your final report

   **For Azure DevOps work items (if relevant):**
   - Use the **codebase-analyzer** agent to get full details of a specific ticket
   - Use the **codebase-locator** agent to find related tickets or historical context
...
5. **Gather metadata for the research document:**
   ...
   - Filename: `docs/shared/research/YYYY-MM-DD-TICKET-ID-description.md`
...
6. **Generate research document:**
   ...
   - Structure the document with YAML frontmatter followed by content:
     ...
     researcher: [Researcher name from docs status]
...
8. **Sync and present findings:**
   - Run `git add docs/ && git commit -m "sync docs"` to save documentation
